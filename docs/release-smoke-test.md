...
```sh
git clone https://github.com/agentic-harness/agentic-harness.git
cd agentic-harness
./scripts/install.sh
...
```sh
agentic-harness new /tmp/agentic-harness-smoke --name agentic-harness-smoke --template coding
...
agentic-harness template validate /tmp/agentic-harness-smoke/.agentic-harness/template-examples/code-review
